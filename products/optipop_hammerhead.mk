...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME="hammerhead" BUILD_FINGERPRINT="google/hammerhead/hammerhead:5.0/LRX21V/1576899:user/release-keys" PRIVATE_BUILD_DESC="hammerhead-user 5.0 LRX21V 1576899 release-keys"
# Kernel inline build
